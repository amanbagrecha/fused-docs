...
- **path** (`str`) – Directory or file to delete, like `s3://fused-users/basic-tier/<handle>/my-old-table/`
...
```python
fused.api.delete("s3://fused-users/basic-tier/<handle>/deprecated_table/")
```
...
- **path** (`str`) – URL to a file, like `s3://fused-users/basic-tier/<handle>/file.parquet`
...
```python
fused.api.get("s3://fused-users/basic-tier/<handle>/file.parquet")
```
...
- **path** (`str`) – Parent directory URL, like `s3://fused-users/basic-tier/<handle>/`
...
```python
fused.api.list("s3://fused-users/basic-tier/<handle>/")
```
...
# Returns: "s3://fused-users/basic-tier/my-handle/my-data/output.parquet"
```
...
```python
fused.api.sign_url("s3://fused-users/basic-tier/<handle>/table_directory/file.parquet")
```
...
- **path** (`str`) – URL to a prefix, like `s3://fused-users/basic-tier/<handle>/some_directory/`
...
```python
fused.api.sign_url_prefix("s3://fused-users/basic-tier/<handle>/table_directory/")
```
...
- **remote_path** (`str`) – URL to upload to, like `s3://fused-users/basic-tier/<handle>/new-file.txt`
...
```py
fused.api.upload("my_file.json", "s3://fused-users/basic-tier/<handle>/my_bucket/my_file.json")
```
